...
class GetReleaseTest(unittest.TestCase):
    ...
    def testArtistCredit(self):
        ...
        res = _common.open_and_parse_test_data(self.datadir, "833d4c3a-2635-4b7a-83c4-4e560588f23a_inc=recordings_artist-credits.xml")
        ...
        res = _common.open_and_parse_test_data(self.datadir, "fbe4490e-e366-4da2-a37a-82162d2f41a9_inc=recordings_artist-credits.xml")
        tracks = res["release"]["medium-list"][0]["track-list"]
        t1 = tracks[1]
    ...
    def testTrackId(self):
        ...
        """
        res = _common.open_and_parse_test_data(self.datadir, "212895ca-ee36-439a-a824-d2620cd10461_inc=recordings.xml")
        tracks = res["release"]["medium-list"][0]["track-list"]
    ...
    def testTrackLength(self):
        ...
        """
        fakedata = os.path.join(os.path.dirname(__file__), "data")
        res = _common.open_and_parse_test_data(fakedata, "fabricated-release.xml")
        tracks = res["release"]["medium-list"][0]["track-list"]
    ...
    def testTrackNumber(self):
        ...
        res = _common.open_and_parse_test_data(self.datadir, "a81f3c15-2f36-47c7-9b0f-f684a8b0530f_inc=recordings.xml")
        tracks = res["release"]["medium-list"][0]["track-list"]
        self.assertEqual(['1', '2'], [t["position"] for t in tracks])
        self.assertEqual(['A', 'B'], [t["number"] for t in tracks])

        res = _common.open_and_parse_test_data(self.datadir, "9ce41d09-40e4-4d33-af0c-7fed1e558dba_inc=recordings.xml")
    ...
    def testVideo(self):
        ...
        """
        res = _common.open_and_parse_test_data(self.datadir, "fe29e7f0-eb46-44ba-9348-694166f47885_inc=recordings.xml")
    ...
    def testPregapTrack(self):
        ...
        """
        res = _common.open_and_parse_test_data(self.datadir, "8eb2b179-643d-3507-b64c-29fcc6745156_inc=recordings.xml")
